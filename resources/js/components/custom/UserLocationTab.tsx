...
function ProfileForm({}: React.ComponentProps<"form">) {
    return (
         ...
         <div>
                    <a href="" className="sign-in-btn">sign in to see your addresses</a>
                     <form action="" >
                        <div className="form-label">
                            <hr aria-hidden="true" />
                            <label htmlFor="zip-code">or enter a US zip code</label>
                            <hr aria-hidden="true" />
                        </div>
                        <div className="zip-code-container">
                            <input type="text" id="zip-code" className="zip-code-input" />
                            <button type="submit" className="zip-code-btn">Apply</button>
                        </div>
                    </form>
                    <form action="" >
                        <div className="form-label">
                            <hr aria-hidden="true" />
                            <label htmlFor="Country-list">or ship outside the US</label>
                            <hr aria-hidden="true" />
                        </div>
                        <select className="country-list-select" id="Country-list" aria-labelledby="GLUXCountryListLabel">
                            <optgroup>
                        ...
                        <button type="submit" className="country-list-btn">Done</button>
                    </form>
